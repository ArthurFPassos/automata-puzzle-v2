...
export function SelectElementsActivityView({ activity, level, worldColor, onResult, locked }: Props) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="text-center text-xs text-slate-500" style={{ fontFamily: FONT_MONO }}>
        {submitted
          ? wasCorrect ? '✓ Caminho correto!' : '❌ Caminho incorreto, tente novamente!'
          : `${selected.length} selecionado(s) — toque na sequência de estados/transições corretos`}
      </div>
